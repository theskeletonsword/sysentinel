...
echo ""
echo "     The write_gid is what lets the daemon send confirmed controls and"
echo "     read cr2/cr3. Without it everything else still works, but those two"
echo "     come back as 'restricted': they are addresses, and handing them to"
echo "     every local process is exactly what a local exploit wants."
echo ""
...
echo "     sudo rmmod sysentinel_metrics"
echo "     sudo modprobe sysentinel_metrics write_gid=\$(id -g sysentinel)"
echo ""
fi
echo "════════════════════════════════════════════════════════════"
